...
t.test("task switcher grid is bounded by both width and height", function()
  ...
  contains(overview, "gridTargetWidth")
  ...
  contains(overview, "Math.min(widthLimitedPreview, heightLimitedPreview)")
end)


t.test("workspace overview uses balanced layouts by window count", function()
  local overview = read("quickshell/gendbyte-workspace-overview/Overview.qml")
  local strip = read("quickshell/gendbyte-workspace-overview/components/WorkspaceStrip.qml")
  ...
  contains(overview, "return 0.88")
  contains(overview, "return 0.92")
  contains(overview, "return 0.84")
  contains(overview, "previewAspect: 0.60")
  contains(strip, "implicitWidth: Math.max(260, workspaceRow.implicitWidth + 34)")
  contains(strip, "implicitHeight: 96")
  contains(strip, "width: modelData.add ? 126 : 142")
  contains(strip, "height: 66")
