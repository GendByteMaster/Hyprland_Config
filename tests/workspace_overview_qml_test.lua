...
t.test("workspace overview uses Hyprland and Wayland live previews", function()
  ...
  contains(overview, 'modalSubmap: "gendbyte-workspace-overview-modal"')
  contains(overview, "function enterModalMode()")
  contains(overview, "function leaveModalMode()")
  contains(overview, 'hl.dsp.submap("reset")')
...
t.test("workspace strip is compact instead of full-width", function()
  local overview = read("quickshell/gendbyte-workspace-overview/Overview.qml")
  local strip = read("quickshell/gendbyte-workspace-overview/components/WorkspaceStrip.qml")
  ...
  contains(overview, "Math.min(620, widthLimitedPreview, heightLimitedPreview)")
end)
