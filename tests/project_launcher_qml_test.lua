...
t.test("project launcher exposes zero-config Open Project keyboard navigation", function()
  local launcher = must_read("quickshell/gendbyte-project-launcher/ProjectLauncher.qml")
  assert_contains(launcher, "function activateDefaultAction()")
...
t.test("project launcher makes navigation pane and primary action explicit", function()
  local launcher = must_read("quickshell/gendbyte-project-launcher/ProjectLauncher.qml")
  local projects = must_read("quickshell/gendbyte-project-launcher/components/ProjectList.qml")
  local actions = must_read("quickshell/gendbyte-project-launcher/components/ActionList.qml")

  assert_contains(launcher, 'property string navigationPane: "projects"')
  assert_contains(launcher, '"PROJECTS  •  ACTIVE"')
  assert_contains(launcher, '"ACTIONS  •  ACTIVE"')
  assert_contains(launcher, '"↑↓ Select  ·  Enter Open Project"')
  assert_contains(launcher, '"↑↓ Select  ·  Enter Run  ·  ← Back"')
  assert_contains(launcher, 'active: root.navigationPane === "projects"')
  assert_contains(launcher, 'active: root.navigationPane === "actions"')
  assert_contains(launcher, 'function focusProjects()')
  assert_contains(launcher, 'navigationPane = "actions"')
  assert_contains(projects, "property bool active: false")
  assert_contains(actions, "property bool active: false")
end)

t.test("Enter from Projects always resolves Open Project as the primary action", function()
  local launcher = must_read("quickshell/gendbyte-project-launcher/ProjectLauncher.qml")

  assert_contains(launcher, 'actions[index].id === "open-workspace"')
  assert_contains(launcher, "selectedActionIndex = primaryIndex")
  assert_contains(launcher, "runSelected(false)")
end)
