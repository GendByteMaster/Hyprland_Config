...
t.test("project launcher UI is a hidden floating window with backend processes", function()
  ...
  assert_contains(qml, "palette: theme")
...
t.test("project launcher folder picker is dark and keyboard navigable", function()
  ...
  assert_contains(picker, "property var palette")
  assert_contains(picker, "root.palette.darkBackground")
  assert_contains(picker, "root.palette.accent")
