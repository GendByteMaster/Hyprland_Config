...
local function fake_repo(root)
  ...
  write(paths.join(root, "lua", "workstation", "omarchy_plugins.lua"), "return {}\n")
  write(paths.join(root, "omarchy", "external-plugins.lua"), "return {}\n")
  write(paths.join(root, "omarchy-plugins.lua"), "return true\n")
