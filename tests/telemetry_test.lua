...
t.test("telemetry parses gpu utilization percent", function()
  near(telemetry.gpu_percent("42\n"), 42)
  near(telemetry.gpu_percent("42 %\n"), 42)
  near(telemetry.gpu_percent("0"), 0)
  near(telemetry.gpu_percent("100"), 100)
end)

t.test("telemetry rejects invalid gpu utilization", function()
  t.eq(telemetry.gpu_percent("-1"), nil)
  t.eq(telemetry.gpu_percent("101"), nil)
  t.eq(telemetry.gpu_percent("not-a-number"), nil)
end)
